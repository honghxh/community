...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        //1、配置数据源
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/community", "root", "123456")
                //2、全局配置
                .globalConfig(builder -> {
                    builder.author("Forrest") // 设置作者名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("comment","discuss_post","login_ticket","message","user") // 设置需要生成的数据表名
